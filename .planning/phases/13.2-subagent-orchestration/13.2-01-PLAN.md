...
must_haves:
  truths:
    ...
    - "Orchestration instructions are included in system prompt"
  artifacts:
  ...
  key_links:
    ...
    - from: "src/memory/context.ts"
      ...
      via: "orchestration instructions integration"
      pattern: "getOrchestrationInstructions"
---
...
Orchestration instructions appended to system prompt when enabled.
...
6. Gateway wires everything: `grep -n "taskListId\|enableSubagents" src/daemon/gateway.ts`
</verification>
