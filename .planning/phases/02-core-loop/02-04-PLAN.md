...
must_haves:
  truths:
    ...
    - "User preferences stated in conversation appear in USER.md"
  artifacts: []
  key_links: []
---
...
### Test 6: USER.md Preference Learning (MEM-06)
1. Send: "I prefer responses in bullet points rather than paragraphs"
2. Wait for response
3. Check if preference was recorded:
```bash
cat ~/.klausbot/identity/USER.md
```
4. USER.md should contain a note about the bullet point preference

**Note:** This is agentic behavior — Claude decides when/what to record. If it doesn't update USER.md on first try, rephrase more explicitly: "Please remember: I always want bullet points."
...
- [ ] USER.md updated with at least one learned preference during testing
  </how-to-verify>
