...
must_haves:
  truths:
    - "Images saved to ~/.klausbot/images/{date}/ with unique filenames"
    - "Image storage directory created on demand"
...
No other changes needed — existing initializeHome() will create the directory.
  </action>
  <verify>
