...
must_haves:
  truths:
    - "Voice file can be downloaded from Telegram to local disk"
    - "Audio file can be transcribed via Whisper API"
    - "Transcription errors are caught and typed"
  artifacts:
...
Output: Three source files providing typed media handling and audio transcription.
</objective>
