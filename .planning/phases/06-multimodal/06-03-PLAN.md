...
No other changes needed — existing persist/load will handle the new field.
  </action>
  <verify>
...
4. `grep "import.*media" src/daemon/gateway.ts` shows media imports
  ...
  <done>
- processMedia transcribes voice, saves images
...
- processMedia function transcribes voice and saves images
